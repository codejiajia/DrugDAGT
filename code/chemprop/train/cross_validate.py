...
def cross_validate(args: TrainArgs,
    ...
    validate_dataset_type(data_right, dataset_type=args.dataset_type)
    ...
    for fold_num in range(args.num_folds):
        ...
        data_right.reset_features_and_targets()
        model_scores = train_func(args, data, data_right, logger)
