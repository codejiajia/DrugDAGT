...
Metric = Literal['auc', 'prc-auc', 'rmse', 'mae', 'mse',
                 'r2', 'accuracy', 'cross_entropy', 'binary_cross_entropy', 'multiclass_auc', 'macro_aupr']
...
class TrainArgs(CommonArgs):
    ...
    data_path_right: str = None
    """Path to data CSV file."""
    index_path: str = None
    """Path to index CSV file"""
    smiles_path: str = None
    '''Path to all used smiles file'''
    ...
    dataset_type: Literal['regression', 'classification', 'multiclass'] = 'multiclass'
    """Type of dataset. This determines the loss function used during training."""
    multiclass_num_classes: int = 87
    """Number of classes when running multiclass classification."""
    separate_val_path: str = None
    """Path to separate val set, optional."""
    separate_val_path_right: str = None
    """Path to separate val set, optional."""
    separate_test_path: str = None
    """Path to separate val set, optional."""
    separate_test_path_right: str = None
    ...
    def process_args(self) -> None:
        ...
        for metric in self.metrics:
            if not ((self.dataset_type == 'classification' and metric in ['auc', 'prc-auc', 'accuracy', 'binary_cross_entropy']) or
                    ...
                    (self.dataset_type == 'multiclass' and metric in ['cross_entropy', 'accuracy', 'multiclass_auc','macro_aupr'])):
                raise ValueError(
